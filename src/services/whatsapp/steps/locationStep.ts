...
export async function handleLocationStep(phoneNumber: string, text: string, msg: any, setSession: (state: string, data: any) => void) {
    ...
    if (msg.location) {
        ...
        // সেশনে লোকেশন সেভ করে স্টেট কনফার্মেশনে নিয়ে যাওয়া
