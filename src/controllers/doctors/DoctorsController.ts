  ...
  try {
    ...
    const doctorsData = [
      ...
      },
      {
        ...
        workingPlace: "মডার্ন ডায়াগনস্টিক সেন্টার, নীলফামারী",
        phone: "01733077010",
        rating: 4.8
      },
      {
        ...
        speciality: "জেনারেল ও ল্যাপারোস্কোপিক সার্জন",
        workingPlace: "শহীদ ডাক্তার শামসুল হক হসপিটাল, সৈয়দপুর",
        phone: "01717000001",
        rating: 4.9
      },
      {
        ...
        workingPlace: "১০০ শয্যা বিশিষ্ট হাসপাতাল, সৈয়দপুর",
        phone: "01717000002",
        rating: 4.8
      },
      {
        ...
        speciality: "স্ত্রী রোগ ও প্রসূতিবিদ্যা বিশেষজ্ঞ",
        workingPlace: "সৈয়দপুর ডায়াবেটিক ও ম্যাটার্নিটি হসপিটাল",
        phone: "01717000003",
        rating: 4.9
      },
      {
        ...
        speciality: "অর্থোপেডিক ও ট্রমা সার্জন",
        workingPlace: "সৈয়দপুর আধুনিক হাসপাতাল",
        phone: "01717000004",
        rating: 4.7
      },
      {
      ...
      },
      {
        ...
        workingPlace: "সৈয়দপুর স্পেশালিষ্ট ক্লিনিক",
        phone: "01717000006",
        rating: 4.7
      },
      {
        ...
        degree: "MBBS, MS (ENT)",
        speciality: "নাক, কান ও গলা বিশেষজ্ঞ",
        workingPlace: "সৈয়দপুর ইসলামী ব্যাংক কমিউনিটি হসপিটাল",
        phone: "01717000007",
        rating: 4.8
      },
      ...
      // ==================== Saidpur additional (5 doctors) ====================
      {
        ...
        degree: "MBBS, BCS (Health), MD (Cardiology)",
        speciality: "হৃদরোগ বিশেষজ্ঞ",
        workingPlace: "সৈয়দপুর ১০০ শয্যা বিশিষ্ট হাসপাতাল, নীলফামারী",
        phone: "01733077026",
        rating: 4.9
      },
      {
        ...
        speciality: "মেডিসিন বিশেষজ্ঞ",
        workingPlace: "সৈয়দপুর জেনারেল হাসপাতাল, নীলফামারী",
        phone: "01733077027",
        rating: 4.8
      },
      {
        ...
        degree: "MBBS, MS (Orthopedics)",
        speciality: "অর্থোপেডিক ও ট্রমা সার্জন",
        workingPlace: "সৈয়দপুর অর্থোপেডিক সেন্টার, নীলফামারী",
        phone: "01733077028",
        rating: 4.7
      },
      {
        ...
        speciality: "স্ত্রী রোগ ও প্রসূতিবিদ্যা বিশেষজ্ঞ",
        workingPlace: "সৈয়দপুর ম্যাটার্নিটি ক্লিনিক, নীলফামারী",
        phone: "01733077029",
        rating: 4.9
      },
      {
        ...
        speciality: "নাক, কান ও গলা বিশেষজ্ঞ",
        workingPlace: "সৈয়দপুর ইসলামী ব্যাংক কমিউনিটি হসপিটাল, নীলফামারী",
        phone: "01733077030",
        rating: 4.8
      },
      ...
      // ==================== Barabari (2 doctors) ====================
      {
        ...
        degree: "MBBS, BCS (Health), MD (Cardiology)",
        speciality: "হৃদরোগ বিশেষজ্ঞ",
        workingPlace: "বড়বাড়ি উপজেলা স্বাস্থ্য কমপ্লেক্স, নীলফামারী",
        phone: "01733077045",
        rating: 4.8
      },
      {
