import { getLocationDetails } from "../services/location/locationService.js";

/**
 * 📍 Processes Lat/Lng, fetches Nominatim details, and returns formatted template data.
 */
export async function getLocationTemplate(lat: number, lng: number) {
    try {
