...
export const FIND_DOCTOR_TEXTS = {
    ...
    AI_CATEGORY_OK: (department: string) =>
        `✅ আপনার সমস্যা অনুযায়ী *${department}* বিভাগের ডাক্তার দেখানো হচ্ছে।\n\nএখন এলাকা বেছে নিন 👇`,
    // A: AI could not classify — user picks manually later.
    AI_CATEGORY_FAIL:
        "😔 সমস্যাটি ঠিক বুঝতে পারিনি। এলাকা বেছে নিন — পরে তালিকা থেকে বিভাগ বেছে নিতে পারবেন 👇",
    ...
    NO_AREA_DOCTOR: (location: string) =>
        `❌ দুঃখিত, "${location}" এলাকায় কোনো ডাক্তার পাওয়া যায়নি। অন্য লোকেশন চেষ্টা করুন অথবা নিচের 🏠 মূল মেনু বাটনে চাপ দিন।`,
...
//   const faq = getFindDoctorFaqAnswer(rawText);
...
export const FIND_DOCTOR_FAQ: FindDoctorFaqItem[] = [
...
export function getFindDoctorFaqAnswer(normText: string): string | null {
