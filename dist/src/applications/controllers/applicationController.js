import { submitDoctorApplication, submitHospitalApplication, listApplications, countPendingApplications, approveApplication, rejectApplication, createDoctor, createHospital, } from '../services/applicationService.js';
...
export const pendingCount = async (_req, res) => {
    try {
...
export const createDoctorDirect = async (req, res) => {
    try {
...
export const createHospitalDirect = async (req, res) => {
    try {
