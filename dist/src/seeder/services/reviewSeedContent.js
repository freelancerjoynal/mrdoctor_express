...
export const REVIEW_COMMENTS = [
    {
        ...
        comment: 'ডাক্তার খুব ধৈর্য ধরে আমার প্রতিটি প্রশ্নের উত্তর দিয়েছেন। প্রথমবারের মতো চিকিৎসকের কাছে এত স্বস্তি পেলাম।',
    },
    {
        rating: 5,
        title: 'সঠিক রোগনির্ণয়',
        comment: 'মা দীর্ঘদিন ধরে অসুখে ভুগছিলেন। ডাক্তারের পরামর্শ ও ওষুধে এখন সম্পূর্ণ নিয়ন্ত্রণে আছেন। আলহামদুলিল্লাহ।',
    },
    {
        rating: 5,
        comment: 'চিকিৎসার প্রতিটি বিষয় বিস্তারিত ব্যাখ্যা করেন, কিছু এড়িয়ে যান না। সত্যিই একজন আন্তরিক চিকিৎসক।',
    },
    {
        rating: 4,
        title: 'ভালো অভিজ্ঞতা',
        comment: 'সিরিয়াল নিতে একটু অপেক্ষা করতে হয়েছে, তবে চিকিৎসা নিয়ে সন্তুষ্ট। রোগ বুঝিয়ে বলার ধরনটা ভালো লেগেছে।',
    },
    {
        rating: 5,
        title: 'অপ্রয়োজনীয় টেস্ট দেন না',
        comment: 'অন্য জায়গায় অনেক টেস্ট লিখেছিল, এখানে শুধু দরকারি পরীক্ষাই দিয়েছেন। খরচও কম হয়েছে, রোগও ধরা পড়েছে।',
    },
    {
        rating: 4,
        comment: 'ব্যবহার খুবই ভালো। ভিড় একটু বেশি থাকে, তাই সময় নিয়ে যাওয়া ভালো। চিকিৎসা ঠিকঠাক পেয়েছি।',
    },
    {
        rating: 5,
        title: 'পরিবারের বিশ্বস্ত ডাক্তার',
        comment: 'আমাদের পুরো পরিবার এখন এখানেই চিকিৎসা নেয়। ফোনে ফলোআপের সুবিধাটা দারুণ। সবাইকে সুপারিশ করব।',
    },
    {
        rating: 3,
        title: 'মোটামুটি',
        comment: 'চিকিৎসা ভালোই, তবে চেম্বারে বসার জায়গা কম আর অপেক্ষার সময়টা বেশি। এই দুটো ঠিক হলে পাঁচ তারকা দিতাম।',
    },
    {
        rating: 5,
        comment: 'জরুরি অবস্থায় রাতেই পরামর্শ পেয়েছি। এমন দায়িত্বশীল আচরণ আজকাল খুব কম দেখা যায়। কৃতজ্ঞ থাকব।',
    },
    {
        rating: 4,
        title: 'সন্তুষ্ট',
        comment: 'ওষুধের পাশাপাশি খাবার আর ব্যায়ামের পরামর্শ দিয়েছেন। এক মাসেই অনেক উন্নতি টের পাচ্ছি।',
    },
    {
        rating: 5,
        title: 'শিশুর জন্য দারুণ',
        comment: 'আমার ছেলে ডাক্তার দেখাতে ভয় পেত, কিন্তু এখানে হাসিমুখে চিকিৎসা নিয়েছে। শিশুদের সাথে ব্যবহার অসাধারণ।',
    },
    {
        rating: 4,
...
export const HOSPITAL_COMMENTS = [
    {
        rating: 5,
...
export function buildDummyReviews(index, hospital = false) {
...
//# sourceMappingURL=reviewSeedContent.js.map