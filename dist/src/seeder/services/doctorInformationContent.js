...
const EXPERTISE_EN_BY_SPECIALITY = {
    'মেডিসিন বিশেষজ্ঞ': [
...
export function buildExpertiseForSpeciality(speciality) {
...
export function buildExpertiseEnForSpeciality(speciality) {
 ...
 */
export function buildTimelineForDoctor(doctor, index) {
...
//# sourceMappingURL=doctorInformationContent.js.map