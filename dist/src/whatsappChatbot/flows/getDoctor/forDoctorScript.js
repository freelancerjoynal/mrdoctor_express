...
function loadScript() {
    try {
        ...
        const raw = require("./for-doctor-only.json");
        const btn = (arr, i, fallback) => {
...
export const DOC_SCRIPT = loadScript();
/** step_1 greeting with the doctor's dynamic name filled in. */
export function docStep1(doctorName) {
...
export function docBackButton() {
    return { id: BACK_BUTTON.id, title: DOC_SCRIPT.backTitle };
}
export function docGenderButtons() {
    return [
...
export function docHistoryButtons() {
    return [
...
export function docPaymentButtons() {
    return [
...
//# sourceMappingURL=forDoctorScript.js.map