...
export async function trackFlowStep(phoneNumber, targetType, flow, step, targetName, targetId) {
    try {
...
export async function saveConnectSession(phoneNumber, targetType, targetId, targetName, lastFlow, lastStep) {
    try {
        await prisma.chatSession.upsert({
            where: { phoneNumber },
...
export async function clearChatSession(phoneNumber) {
