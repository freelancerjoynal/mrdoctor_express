...
export const getUserProfile = async (req, res) => {
    try {
        ...
        const profile = await getProfileData({ userId: req.user.userId, role: req.user.role }, targetUserId);
        if (!profile)
...
export const updateUserProfile = async (req, res) => {
    try {
        const profile = await updateProfileData({ userId: req.user.userId, role: req.user.role }, {
            name: req.body?.name,
