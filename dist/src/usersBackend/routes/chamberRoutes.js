...
import { listUserChambers, storeUserChamber, modifyUserChamber, removeUserChamber, listUserHospitalOptions, listUserSchedules, storeUserSchedule, modifyUserSchedule, removeUserSchedule, } from '../controllers/chamberController.js';
const chamberRouter = express.Router();
const MANAGERS = ['SUPER_ADMIN', 'ADMIN_MANAGER', 'DOCTOR', 'DOCTOR_STAFF'];
...
//# sourceMappingURL=chamberRoutes.js.map