...
type GetContactMessageGroupByPayload<T extends ContactMessageGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ContactMessageGroupByOutputType, T['by']> & {
...
export type ContactMessageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "phone" | "email" | "topic" | "subject" | "message" | "status" | "source" | "createdAt" | "updatedAt", ExtArgs["result"]["contactMessage"]>;
